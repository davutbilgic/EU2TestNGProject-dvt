...
public class WebTablesExample {
    ...
    public void PrintAllCellsByIndex(){
        ...
        System.out.println("=================================");
        returnElement(3,2);
        System.out.println("returnElement(4,3) = " + returnElement(4, 3));
        System.out.println("returnElement(4,3).getText() = " + returnElement(4, 3).getText());
    }

    @Test
    public void getCellInRelationToanotherCellInSameRow(){
        String firstName = "John";
        String xpath = "//table[@id='table1']//td[.='"+firstName+"']/../td[3]";//hangi ismi girersen gir o ismin mailini alir
        WebElement email = driver.findElement(By.xpath(xpath));
        System.out.println(email.getText());
    }

    private WebElement returnElement(int rowNumber, int columnNumber){
        String cellXpath = "//table[@id='table1']/tbody/tr["+rowNumber+"]/td["+ columnNumber +"]";
